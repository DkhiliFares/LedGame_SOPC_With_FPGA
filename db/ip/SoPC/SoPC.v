...
// Generated using ACDS version 13.0sp1 232 at 2025.11.24.01:12:50
...
module SoPC (
	...
	wire         mon_processeur_instruction_master_waitrequest;                                                         // mon_processeur_instruction_master_translator:av_waitrequest -> mon_processeur:i_waitrequest
	wire  [15:0] mon_processeur_instruction_master_address;                                                             // mon_processeur:i_address -> mon_processeur_instruction_master_translator:av_address
	wire         mon_processeur_instruction_master_read;                                                                // mon_processeur:i_read -> mon_processeur_instruction_master_translator:av_read
	wire  [31:0] mon_processeur_instruction_master_readdata;                                                            // mon_processeur_instruction_master_translator:av_readdata -> mon_processeur:i_readdata
	wire         mon_processeur_data_master_waitrequest;                                                                // mon_processeur_data_master_translator:av_waitrequest -> mon_processeur:d_waitrequest
	wire  [31:0] mon_processeur_data_master_writedata;                                                                  // mon_processeur:d_writedata -> mon_processeur_data_master_translator:av_writedata
	wire  [15:0] mon_processeur_data_master_address;                                                                    // mon_processeur:d_address -> mon_processeur_data_master_translator:av_address
	wire         mon_processeur_data_master_write;                                                                      // mon_processeur:d_write -> mon_processeur_data_master_translator:av_write
	wire         mon_processeur_data_master_read;                                                                       // mon_processeur:d_read -> mon_processeur_data_master_translator:av_read
	wire  [31:0] mon_processeur_data_master_readdata;                                                                   // mon_processeur_data_master_translator:av_readdata -> mon_processeur:d_readdata
	wire         mon_processeur_data_master_debugaccess;                                                                // mon_processeur:jtag_debug_module_debugaccess_to_roms -> mon_processeur_data_master_translator:av_debugaccess
	wire   [3:0] mon_processeur_data_master_byteenable;                                                                 // mon_processeur:d_byteenable -> mon_processeur_data_master_translator:av_byteenable
	wire         mon_processeur_jtag_debug_module_translator_avalon_anti_slave_0_waitrequest;                           // mon_processeur:jtag_debug_module_waitrequest -> mon_processeur_jtag_debug_module_translator:av_waitrequest
	wire  [31:0] mon_processeur_jtag_debug_module_translator_avalon_anti_slave_0_writedata;                             // mon_processeur_jtag_debug_module_translator:av_writedata -> mon_processeur:jtag_debug_module_writedata
	wire   [8:0] mon_processeur_jtag_debug_module_translator_avalon_anti_slave_0_address;                               // mon_processeur_jtag_debug_module_translator:av_address -> mon_processeur:jtag_debug_module_address
	wire         mon_processeur_jtag_debug_module_translator_avalon_anti_slave_0_write;                                 // mon_processeur_jtag_debug_module_translator:av_write -> mon_processeur:jtag_debug_module_write
	wire         mon_processeur_jtag_debug_module_translator_avalon_anti_slave_0_read;                                  // mon_processeur_jtag_debug_module_translator:av_read -> mon_processeur:jtag_debug_module_read
	wire  [31:0] mon_processeur_jtag_debug_module_translator_avalon_anti_slave_0_readdata;                              // mon_processeur:jtag_debug_module_readdata -> mon_processeur_jtag_debug_module_translator:av_readdata
	wire         mon_processeur_jtag_debug_module_translator_avalon_anti_slave_0_debugaccess;                           // mon_processeur_jtag_debug_module_translator:av_debugaccess -> mon_processeur:jtag_debug_module_debugaccess
	wire   [3:0] mon_processeur_jtag_debug_module_translator_avalon_anti_slave_0_byteenable;                            // mon_processeur_jtag_debug_module_translator:av_byteenable -> mon_processeur:jtag_debug_module_byteenable
	...
	wire         mon_processeur_instruction_master_translator_avalon_universal_master_0_waitrequest;                    // mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:av_waitrequest -> mon_processeur_instruction_master_translator:uav_waitrequest
	wire   [2:0] mon_processeur_instruction_master_translator_avalon_universal_master_0_burstcount;                     // mon_processeur_instruction_master_translator:uav_burstcount -> mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:av_burstcount
	wire  [31:0] mon_processeur_instruction_master_translator_avalon_universal_master_0_writedata;                      // mon_processeur_instruction_master_translator:uav_writedata -> mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:av_writedata
	wire  [15:0] mon_processeur_instruction_master_translator_avalon_universal_master_0_address;                        // mon_processeur_instruction_master_translator:uav_address -> mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:av_address
	wire         mon_processeur_instruction_master_translator_avalon_universal_master_0_lock;                           // mon_processeur_instruction_master_translator:uav_lock -> mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:av_lock
	wire         mon_processeur_instruction_master_translator_avalon_universal_master_0_write;                          // mon_processeur_instruction_master_translator:uav_write -> mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:av_write
	wire         mon_processeur_instruction_master_translator_avalon_universal_master_0_read;                           // mon_processeur_instruction_master_translator:uav_read -> mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:av_read
	wire  [31:0] mon_processeur_instruction_master_translator_avalon_universal_master_0_readdata;                       // mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:av_readdata -> mon_processeur_instruction_master_translator:uav_readdata
	wire         mon_processeur_instruction_master_translator_avalon_universal_master_0_debugaccess;                    // mon_processeur_instruction_master_translator:uav_debugaccess -> mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:av_debugaccess
	wire   [3:0] mon_processeur_instruction_master_translator_avalon_universal_master_0_byteenable;                     // mon_processeur_instruction_master_translator:uav_byteenable -> mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:av_byteenable
	wire         mon_processeur_instruction_master_translator_avalon_universal_master_0_readdatavalid;                  // mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:av_readdatavalid -> mon_processeur_instruction_master_translator:uav_readdatavalid
	wire         mon_processeur_data_master_translator_avalon_universal_master_0_waitrequest;                           // mon_processeur_data_master_translator_avalon_universal_master_0_agent:av_waitrequest -> mon_processeur_data_master_translator:uav_waitrequest
	wire   [2:0] mon_processeur_data_master_translator_avalon_universal_master_0_burstcount;                            // mon_processeur_data_master_translator:uav_burstcount -> mon_processeur_data_master_translator_avalon_universal_master_0_agent:av_burstcount
	wire  [31:0] mon_processeur_data_master_translator_avalon_universal_master_0_writedata;                             // mon_processeur_data_master_translator:uav_writedata -> mon_processeur_data_master_translator_avalon_universal_master_0_agent:av_writedata
	wire  [15:0] mon_processeur_data_master_translator_avalon_universal_master_0_address;                               // mon_processeur_data_master_translator:uav_address -> mon_processeur_data_master_translator_avalon_universal_master_0_agent:av_address
	wire         mon_processeur_data_master_translator_avalon_universal_master_0_lock;                                  // mon_processeur_data_master_translator:uav_lock -> mon_processeur_data_master_translator_avalon_universal_master_0_agent:av_lock
	wire         mon_processeur_data_master_translator_avalon_universal_master_0_write;                                 // mon_processeur_data_master_translator:uav_write -> mon_processeur_data_master_translator_avalon_universal_master_0_agent:av_write
	wire         mon_processeur_data_master_translator_avalon_universal_master_0_read;                                  // mon_processeur_data_master_translator:uav_read -> mon_processeur_data_master_translator_avalon_universal_master_0_agent:av_read
	wire  [31:0] mon_processeur_data_master_translator_avalon_universal_master_0_readdata;                              // mon_processeur_data_master_translator_avalon_universal_master_0_agent:av_readdata -> mon_processeur_data_master_translator:uav_readdata
	wire         mon_processeur_data_master_translator_avalon_universal_master_0_debugaccess;                           // mon_processeur_data_master_translator:uav_debugaccess -> mon_processeur_data_master_translator_avalon_universal_master_0_agent:av_debugaccess
	wire   [3:0] mon_processeur_data_master_translator_avalon_universal_master_0_byteenable;                            // mon_processeur_data_master_translator:uav_byteenable -> mon_processeur_data_master_translator_avalon_universal_master_0_agent:av_byteenable
	wire         mon_processeur_data_master_translator_avalon_universal_master_0_readdatavalid;                         // mon_processeur_data_master_translator_avalon_universal_master_0_agent:av_readdatavalid -> mon_processeur_data_master_translator:uav_readdatavalid
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_m0_waitrequest;             // mon_processeur_jtag_debug_module_translator:uav_waitrequest -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:m0_waitrequest
	wire   [2:0] mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_m0_burstcount;              // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:m0_burstcount -> mon_processeur_jtag_debug_module_translator:uav_burstcount
	wire  [31:0] mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_m0_writedata;               // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:m0_writedata -> mon_processeur_jtag_debug_module_translator:uav_writedata
	wire  [15:0] mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_m0_address;                 // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:m0_address -> mon_processeur_jtag_debug_module_translator:uav_address
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_m0_write;                   // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:m0_write -> mon_processeur_jtag_debug_module_translator:uav_write
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_m0_lock;                    // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:m0_lock -> mon_processeur_jtag_debug_module_translator:uav_lock
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_m0_read;                    // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:m0_read -> mon_processeur_jtag_debug_module_translator:uav_read
	wire  [31:0] mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_m0_readdata;                // mon_processeur_jtag_debug_module_translator:uav_readdata -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:m0_readdata
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_m0_readdatavalid;           // mon_processeur_jtag_debug_module_translator:uav_readdatavalid -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:m0_readdatavalid
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_m0_debugaccess;             // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:m0_debugaccess -> mon_processeur_jtag_debug_module_translator:uav_debugaccess
	wire   [3:0] mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_m0_byteenable;              // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:m0_byteenable -> mon_processeur_jtag_debug_module_translator:uav_byteenable
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rf_source_endofpacket;      // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rf_source_endofpacket -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo:in_endofpacket
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rf_source_valid;            // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rf_source_valid -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo:in_valid
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rf_source_startofpacket;    // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rf_source_startofpacket -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo:in_startofpacket
	wire  [89:0] mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rf_source_data;             // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rf_source_data -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo:in_data
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rf_source_ready;            // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo:in_ready -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rf_source_ready
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo_out_endofpacket;   // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo:out_endofpacket -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rf_sink_endofpacket
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo_out_valid;         // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo:out_valid -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rf_sink_valid
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo_out_startofpacket; // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo:out_startofpacket -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rf_sink_startofpacket
	wire  [89:0] mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo_out_data;          // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo:out_data -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rf_sink_data
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo_out_ready;         // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rf_sink_ready -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo:out_ready
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rdata_fifo_src_valid;       // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rdata_fifo_src_valid -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rdata_fifo_sink_valid
	wire  [33:0] mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rdata_fifo_src_data;        // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rdata_fifo_src_data -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rdata_fifo_sink_data
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rdata_fifo_src_ready;       // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rdata_fifo_sink_ready -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rdata_fifo_src_ready
	...
	wire  [15:0] switches_s1_translator_avalon_universal_slave_0_agent_m0_address;                                      // switches_s1_translator_avalon_universal_slave_0_agent:m0_address -> switches_s1_translator:uav_address
	...
	wire  [89:0] switches_s1_translator_avalon_universal_slave_0_agent_rf_source_data;                                  // switches_s1_translator_avalon_universal_slave_0_agent:rf_source_data -> switches_s1_translator_avalon_universal_slave_0_agent_rsp_fifo:in_data
	...
	wire  [89:0] switches_s1_translator_avalon_universal_slave_0_agent_rsp_fifo_out_data;                               // switches_s1_translator_avalon_universal_slave_0_agent_rsp_fifo:out_data -> switches_s1_translator_avalon_universal_slave_0_agent:rf_sink_data
	...
	wire  [15:0] leds_s1_translator_avalon_universal_slave_0_agent_m0_address;                                          // leds_s1_translator_avalon_universal_slave_0_agent:m0_address -> leds_s1_translator:uav_address
	...
	wire         mon_processeur_instruction_master_translator_avalon_universal_master_0_agent_cp_endofpacket;           // mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:cp_endofpacket -> addr_router:sink_endofpacket
	wire         mon_processeur_instruction_master_translator_avalon_universal_master_0_agent_cp_valid;                 // mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:cp_valid -> addr_router:sink_valid
	wire         mon_processeur_instruction_master_translator_avalon_universal_master_0_agent_cp_startofpacket;         // mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:cp_startofpacket -> addr_router:sink_startofpacket
	wire  [88:0] mon_processeur_instruction_master_translator_avalon_universal_master_0_agent_cp_data;                  // mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:cp_data -> addr_router:sink_data
	wire         mon_processeur_instruction_master_translator_avalon_universal_master_0_agent_cp_ready;                 // addr_router:sink_ready -> mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:cp_ready
	wire         mon_processeur_data_master_translator_avalon_universal_master_0_agent_cp_endofpacket;                  // mon_processeur_data_master_translator_avalon_universal_master_0_agent:cp_endofpacket -> addr_router_001:sink_endofpacket
	wire         mon_processeur_data_master_translator_avalon_universal_master_0_agent_cp_valid;                        // mon_processeur_data_master_translator_avalon_universal_master_0_agent:cp_valid -> addr_router_001:sink_valid
	wire         mon_processeur_data_master_translator_avalon_universal_master_0_agent_cp_startofpacket;                // mon_processeur_data_master_translator_avalon_universal_master_0_agent:cp_startofpacket -> addr_router_001:sink_startofpacket
	wire  [88:0] mon_processeur_data_master_translator_avalon_universal_master_0_agent_cp_data;                         // mon_processeur_data_master_translator_avalon_universal_master_0_agent:cp_data -> addr_router_001:sink_data
	wire         mon_processeur_data_master_translator_avalon_universal_master_0_agent_cp_ready;                        // addr_router_001:sink_ready -> mon_processeur_data_master_translator_avalon_universal_master_0_agent:cp_ready
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rp_endofpacket;             // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rp_endofpacket -> id_router:sink_endofpacket
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rp_valid;                   // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rp_valid -> id_router:sink_valid
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rp_startofpacket;           // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rp_startofpacket -> id_router:sink_startofpacket
	wire  [88:0] mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rp_data;                    // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rp_data -> id_router:sink_data
	wire         mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rp_ready;                   // id_router:sink_ready -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:rp_ready
	...
	wire  [88:0] sysid_qsys_0_control_slave_translator_avalon_universal_slave_0_agent_rp_data;                          // sysid_qsys_0_control_slave_translator_avalon_universal_slave_0_agent:rp_data -> id_router_003:sink_data
	...
	wire  [88:0] switches_s1_translator_avalon_universal_slave_0_agent_rp_data;                                         // switches_s1_translator_avalon_universal_slave_0_agent:rp_data -> id_router_004:sink_data
	...
	wire  [88:0] leds_s1_translator_avalon_universal_slave_0_agent_rp_data;                                             // leds_s1_translator_avalon_universal_slave_0_agent:rp_data -> id_router_005:sink_data
	...
	wire  [88:0] cmd_xbar_demux_001_src3_data;                                                                          // cmd_xbar_demux_001:src3_data -> sysid_qsys_0_control_slave_translator_avalon_universal_slave_0_agent:cp_data
	...
	wire  [88:0] cmd_xbar_demux_001_src4_data;                                                                          // cmd_xbar_demux_001:src4_data -> switches_s1_translator_avalon_universal_slave_0_agent:cp_data
	wire   [5:0] cmd_xbar_demux_001_src4_channel;                                                                       // cmd_xbar_demux_001:src4_channel -> switches_s1_translator_avalon_universal_slave_0_agent:cp_channel
	...
	wire  [88:0] cmd_xbar_demux_001_src5_data;                                                                          // cmd_xbar_demux_001:src5_data -> leds_s1_translator_avalon_universal_slave_0_agent:cp_data
	...
	wire         rsp_xbar_mux_src_endofpacket;                                                                          // rsp_xbar_mux:src_endofpacket -> mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:rp_endofpacket
	wire         rsp_xbar_mux_src_valid;                                                                                // rsp_xbar_mux:src_valid -> mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:rp_valid
	wire         rsp_xbar_mux_src_startofpacket;                                                                        // rsp_xbar_mux:src_startofpacket -> mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:rp_startofpacket
	wire  [88:0] rsp_xbar_mux_src_data;                                                                                 // rsp_xbar_mux:src_data -> mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:rp_data
	wire   [5:0] rsp_xbar_mux_src_channel;                                                                              // rsp_xbar_mux:src_channel -> mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:rp_channel
	wire         rsp_xbar_mux_src_ready;                                                                                // mon_processeur_instruction_master_translator_avalon_universal_master_0_agent:rp_ready -> rsp_xbar_mux:src_ready
	...
	wire         rsp_xbar_mux_001_src_endofpacket;                                                                      // rsp_xbar_mux_001:src_endofpacket -> mon_processeur_data_master_translator_avalon_universal_master_0_agent:rp_endofpacket
	wire         rsp_xbar_mux_001_src_valid;                                                                            // rsp_xbar_mux_001:src_valid -> mon_processeur_data_master_translator_avalon_universal_master_0_agent:rp_valid
	wire         rsp_xbar_mux_001_src_startofpacket;                                                                    // rsp_xbar_mux_001:src_startofpacket -> mon_processeur_data_master_translator_avalon_universal_master_0_agent:rp_startofpacket
	wire  [88:0] rsp_xbar_mux_001_src_data;                                                                             // rsp_xbar_mux_001:src_data -> mon_processeur_data_master_translator_avalon_universal_master_0_agent:rp_data
	wire   [5:0] rsp_xbar_mux_001_src_channel;                                                                          // rsp_xbar_mux_001:src_channel -> mon_processeur_data_master_translator_avalon_universal_master_0_agent:rp_channel
	wire         rsp_xbar_mux_001_src_ready;                                                                            // mon_processeur_data_master_translator_avalon_universal_master_0_agent:rp_ready -> rsp_xbar_mux_001:src_ready
	wire         cmd_xbar_mux_src_endofpacket;                                                                          // cmd_xbar_mux:src_endofpacket -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:cp_endofpacket
	wire         cmd_xbar_mux_src_valid;                                                                                // cmd_xbar_mux:src_valid -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:cp_valid
	wire         cmd_xbar_mux_src_startofpacket;                                                                        // cmd_xbar_mux:src_startofpacket -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:cp_startofpacket
	wire  [88:0] cmd_xbar_mux_src_data;                                                                                 // cmd_xbar_mux:src_data -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:cp_data
	wire   [5:0] cmd_xbar_mux_src_channel;                                                                              // cmd_xbar_mux:src_channel -> mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:cp_channel
	wire         cmd_xbar_mux_src_ready;                                                                                // mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent:cp_ready -> cmd_xbar_mux:src_ready
	...
	wire  [31:0] mon_processeur_d_irq_irq;                                                                              // irq_mapper:sender_irq -> mon_processeur:d_irq

	SoPC_mon_processeur mon_processeur (
		.clk                                   (clk_clk),                                                                     //                       clk.clk
	...
	) mon_processeur_instruction_master_translator (
		.clk                      (clk_clk),                                                                              //                       clk.clk
	...
	) mon_processeur_data_master_translator (
		.clk                      (clk_clk),                                                                       //                       clk.clk
		.reset                    (rst_controller_reset_out_reset),                                                //                     reset.reset
	...
	) mon_processeur_jtag_debug_module_translator (
		.clk                      (clk_clk),                                                                                     //                      clk.clk
		.reset                    (rst_controller_reset_out_reset),                                                              //                    reset.reset
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) mon_processeur_instruction_master_translator_avalon_universal_master_0_agent (
		.clk                     (clk_clk),                                                                                       //       clk.clk
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) mon_processeur_data_master_translator_avalon_universal_master_0_agent (
		.clk                     (clk_clk),                                                                                //       clk.clk
		.reset                   (rst_controller_reset_out_reset),                                                         // clk_reset.reset
	...
	) mon_processeur_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo (
		.clk               (clk_clk),                                                                                               //       clk.clk
		.reset             (rst_controller_reset_out_reset),                                                                        // clk_reset.reset
