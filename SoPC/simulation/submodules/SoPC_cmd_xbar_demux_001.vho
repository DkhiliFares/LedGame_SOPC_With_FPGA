...
--synthesis_resources = 
 ...
 ENTITY  SoPC_cmd_xbar_demux_001 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 src5_data	:	OUT  STD_LOGIC_VECTOR (88 DOWNTO 0);
		 src5_endofpacket	:	OUT  STD_LOGIC;
		 src5_ready	:	IN  STD_LOGIC;
		 src5_startofpacket	:	OUT  STD_LOGIC;
		 src5_valid	:	OUT  STD_LOGIC
	 ); 
 END SoPC_cmd_xbar_demux_001;

 ARCHITECTURE RTL OF SoPC_cmd_xbar_demux_001 IS
	 ...
	 SIGNAL  s_wire_sopc_cmd_xbar_demux_001_wideor0_13_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	s_wire_sopc_cmd_xbar_demux_001_wideor0_13_dataout <= (((((wire_w_lg_w_sink_channel_range1w2w(0) OR wire_w_lg_w_sink_channel_range3w4w(0)) OR wire_w_lg_w_sink_channel_range6w7w(0)) OR wire_w_lg_w_sink_channel_range9w10w(0)) OR wire_w_lg_w_sink_channel_range12w13w(0)) OR wire_w_lg_w_sink_channel_range15w16w(0));
	sink_ready <= s_wire_sopc_cmd_xbar_demux_001_wideor0_13_dataout;
	...
	src5_data <= ( sink_data(88 DOWNTO 0));
 ...
 END RTL; --SoPC_cmd_xbar_demux_001
