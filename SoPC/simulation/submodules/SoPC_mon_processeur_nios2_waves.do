add wave -noupdate -divider {SoPC_mon_processeur: top-level ports}
...
add wave -noupdate -divider {SoPC_mon_processeur: common}
...
add wave -noupdate -divider {SoPC_mon_processeur: breaks}
